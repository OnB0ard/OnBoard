...
public class DayScheduleController {
    ...
    @PutMapping("/{dayScheduleId}/updateSchedulePosition")
    public CommonResponse<SuccessResponseDTO> updateSchedulePosition(@PathVariable Long planId, @PathVariable Long dayScheduleId, @RequestBody UpdateSchedulePositionRequestDTO updateSchedulePositionRequestDTO, @AuthenticationPrincipal JwtUserInfo jwtUserInfo) {
        return new CommonResponse<>(new SuccessResponseDTO(dayScheduleService.updateSchedulePosition(planId, dayScheduleId, updateSchedulePositionRequestDTO, jwtUserInfo.getUserId())), HttpStatus.OK);
    }
